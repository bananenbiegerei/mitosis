...
<div>
    <div class="letter-x">
        <h1 class="text-7xl text-fuchsia-500">X</h1>
    </div>
    ...
    <a href="https://github.com/alexfoxy/lax.js" class="github-corner" aria-label="View source on GitHub"><svg
